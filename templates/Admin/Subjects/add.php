 ...
 */
$this->assign('title', __('Add Subject'));
?>
...
<section class="admin-section">
    <header class="admin-section__header">
        <div>
            <nav class="breadcrumb">
                <?= $this->Html->link(__('Subjects'), ['action' => 'index']) ?> / <?= __('Add') ?>
            </nav>
            <h1><?= __('Add Subject') ?></h1>
        </div>
    </header>
    ...
    <div class="form-card">
        ...
        <div class="form-row">
            <div class="form-group form-group--full">
                <?= $this->Form->control('description', [
                    ...
                    'class' => 'form-control',
                    'rows' => 3,
                    'placeholder' => __('Brief description of the subject...'),
                ]) ?>
            </div>
        </div>
        ...
        <div class="form-actions">
            ...
            <?= $this->Form->button(__('Create Subject'), ['class' => 'btn btn--solid']) ?>
        </div>
