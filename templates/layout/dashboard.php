...
$navGroups = [
    ...
    'academic' => [
        ...
        'items' => [
            ...
            ['label' => __('Class Routine'), 'url' => '/admin/class-routines', 'icon' => 'routine', 'color' => 'rose'],
            ['label' => __('Calendar'), 'url' => '/admin/academic-calendar', 'icon' => 'calendar', 'color' => 'sky'],
...
$icons = [
    ...
    'routine' => '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="3" y1="10" x2="21" y2="10"/><line x1="9" y1="4" x2="9" y2="22"/><line x1="15" y1="4" x2="15" y2="22"/><line x1="3" y1="16" x2="21" y2="16"/></svg>',
