...
$this->assign('dashboardTitle', __('Update Grades'));
$this->assign('dashboardSubtitle', h($course->display_name) . ' - ' . h($course->academic_year));
?>
    ...
    <div class="form-card">
        <?php if ($enrollments->count() > 0): ?>
            ...
            <div class="grades-info">
                <div class="alert alert--info">
                    <strong><?= __('Cambridge Grading Scale:') ?></strong>
                    <?= __('A* (90-100%), A (80-89%), B (70-79%), C (60-69%), D (50-59%), E (40-49%), U (Below 40%)') ?>
                </div>
            </div>
                                ...
                                <td>
                                    <div class="user-info">
                                        ...
                                        <div>
                                            ...
                                            <br><small class="text-muted"><?= __('Enrolled: {0}', $enrollment->enrolled_date->format('M j, Y')) ?></small>
                                        </div>
                                    </div>
                                </td>
                                <td>
        ...
        <?php else: ?>
            <div class="empty-state">
                ...
                <p><?= __('There are no students enrolled in this course yet.') ?></p>
